final List<Map<String, dynamic>> animationPages = [
  {
    'title': 'Crossfade',
    'description':
  ...
  },
  {
    'title': 'Lottie',
    'description':
        'Lottie in Flutter displays lightweight, customizable animations exported as JSON, enhancing app visuals efficiently.',
  },
  {
    'title': 'Rive',
    'description':
        'Rive in Flutter adds real-time, interactive animations created in Rive, enabling smooth, customizable visuals across platforms.',
  },
];
